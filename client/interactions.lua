...
local function HandcuffedEscorted()
    ...
    if PlayerData.metadata.ishandcuffed then
        ...
        if (not IsEntityPlayingAnim(cache.ped, "mp_arresting", "idle", 3) and not IsEntityPlayingAnim(cache.ped, "mp_arrest_paired", "crook_p2_back_right", 3)) and not PlayerData.metadata.isdead then

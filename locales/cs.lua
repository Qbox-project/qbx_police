local Translations = {
    ...
    email = {
        ...
        message = 'Vážený/á %{value}. %{value2}, <br /><br />Centrální soudní exekutorská agentura (CJCA) naúčtovala pokuty, které jste obdrželi od policie.<br />Z vašeho účtu bylo vybráno <strong>$%{value3}</strong>.<br /><br />S pozdravem,<br />Pan I.K. Graai',
    },
    commands = {

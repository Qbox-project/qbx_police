local Translations = {
    error = {
        ...
        amount_higher = 'Betrag muss größer als 0 sein',
        vehicle_cuff = 'Du kannst niemanden im Fahrzeug die Handschellen anlegen',
        ...
        rank_license = 'Du hast nicht die erforderliche Rangstufe, um eine Lizenz zu vergeben',
        ...
        no_rob = 'Diese Person ist nicht gefesselt, tot oder hat die Hände hoch.',
    },
    success = {
        ...
        impound_vehicle_removed = 'Fahrzeug aus dem Verwahrhof entfernt!',
        impounded = 'Fahrzeugbeschlagnahmung',
    },
    info = {
        mr = 'Mr.',
        mrs = 'Mrs.',
        ...
        camera_id = ' - Kamera ID: ',
        camera_id_help = 'ID der Kamera',
        callsign_name = 'Funkrufname',
        ...
        license_type = 'Lizenztyp (FÜhrerschein/Waffen)',
        ankle_location = 'Fußfessel-Position',
        cuff = 'Du wurdest gefesselt!',
        cuffed_walk = 'Du wurdest gefesselt, aber kannst gehen',
        vehicle_flagged = 'Das Fahrzeug %{vehicle} ist mit folgendem Grund markiert: %{reason}',
        unflag_vehicle = 'Das Fahrzeug %{vehicle} ist nicht mehr markiert',
        tow_driver_paid = 'Du hast den Abschlepper bezahlt',
        paid_lawyer = 'Du hast den Anwalt bezahlt',
        vehicle_taken_depot = 'Fahrzeug wird in den Verwahrhof gebracht. Kosten: $%{price}',
        vehicle_seized = 'Fahrzeug beschlagnahmt!',
        stolen_money = 'Du hast €%{stolen} gestohlen',
        cash_robbed = 'Dir wurde $%{money} gestohlen',
        ...
        searched_success = 'Du hast die Durchsuchung der Person durchgeführt',
        cash_found = 'Dieser Bürger hat €%{cash} Bargeld in seiner Tasche',
        sent_jail_for = 'Du hast die Person für %{time} Monate inhaftiert',
        fine_received = 'Du hast eine Strafe über €%{fine} bekommen!',
        blip_text = '#DISPATCH ALARM - %{value}',
        ...
        evidence_stash = 'Spurensicherungslager | %{value}',
        slot = 'Regal-Nr. (1,2,3)',
        current_evidence = '%{value} | Regal %{value2}',
        on_duty = '[E] - Einstempeln',
        off_duty = '[E] - Ausstempeln',
        onoff_duty = 'EIN/AUS Dienst',
        stash = 'Schließfach %{value}',
        delete_spike = '[E] - Nagelband entfernen',
        close_camera = 'Kamera schließen',
        bullet_casing = '[G] - Patronenhülse %{value}',
        casing = 'Patronenhülse',
        blood = 'Blut',
        blood_text = '[G] - Blut %{value}',
        fingerprint_text = '[G] - Fingerabdruck',
        fingerprint = 'Fingerabdruck',
        store_heli = '[E] - Helikopter einparken',
        take_heli = '[E] - Helikopter ausparken',
        impound_veh = '[E] - Fahrzeug beschlagnahmen',
        store_veh = '[E] - Fahrzeug einparken',
        grab_veh = '[E] - Fahrzeug ausparken',
        armory = 'Waffenkammer',
    ...
    email = {
        ...
        message = 'Sehr geehrte/r %{value}. %{value2}, <br /><br />Die Justiz hat beschlossen Ihre Strafzettel beim Staat einzutreiben.<br />Der ausständige Betrag von <strong>$%{value3}</strong> wurde von ihrem Konto abgebucht.<br /><br />Mit freundlichen Grüßen,<br />Department of Justice',
    },
    commands = {
        place_spike = 'Platziere Nagelband (Polizei)',
        license_grant = 'Lizenz ausstellen',
        license_revoke = 'Lizenz entziehen',
        place_object = 'Objekt platzieren/löschen (Polizei)',
        cuff_player = 'Person festnehmen (Polizei)',
        escort = 'Person eskortieren',
        callsign = 'Funkrufname',
        clear_casign = 'Bereich Säubern von Patronenhülsen (Polizei)',
        jail_player = 'Ins Gefängnis stecken (Polizei)',
        unjail_player = 'Person freilassen (Polizei)',
        ...
        depot = 'Verwahrhof mit Preis (Polizei)',
        ...
        ankletlocation = 'Ort der Fußfessel einer Person orten',
        removeanklet = 'Fußfessel entfernen (Polizei)',
